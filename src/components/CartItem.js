      ...
      <div className='w-full min-h-[150px] flex items-center gap-x-4'>
        ...
        <div className='w-full flex flex-col'>
          <div className='flex justify-between mb-2'>
           <Link to={`/product/${id}`}  className='text-sm uppercase font-medium maw-w-[240px] text-primary hover:underline'>
            {title}
            </Link> 
          ...
          <div className=' flex gap-x-2 h-[36px text-sm ] '>
            <div className='flex fle-1 max-w-[100px] items-center h-full border text-primary font-medium'>
